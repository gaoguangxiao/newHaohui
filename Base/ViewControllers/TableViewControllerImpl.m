...
#import "TableViewControllerImpl.h"

@interface TableViewControllerImpl ()

@end

@implementation TableViewControllerImpl

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.baseData = [NSMutableArray new];
