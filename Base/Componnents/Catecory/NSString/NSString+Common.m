...
- (NSMutableAttributedString *)containsStringfirstStr:(NSString *)firststr andkeyColor:(UIColor *)color andSecondString:(NSString *)secondstr andkeyColor:(UIColor *)secondcolor{
    NSRange range = [self rangeOfString:firststr options:NSCaseInsensitiveSearch];//第一
    NSRange srange = [self rangeOfString:secondstr options:NSCaseInsensitiveSearch];
    NSMutableAttributedString *strAtt = [[NSMutableAttributedString alloc] initWithString:self];
    [strAtt addAttributes:@{NSForegroundColorAttributeName:color} range:NSMakeRange(range.location, range.length)];
    [strAtt addAttributes:@{NSForegroundColorAttributeName:secondcolor} range:NSMakeRange(srange.location, srange.length)];
    return strAtt;
